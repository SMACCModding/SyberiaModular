...
class CfgVehicles {
	...
	class Land_House_1B01_Pub_Livespace0: BuildingLivespace
    {
		...
		model="\SyberiaScripts\data\building\Land_House\house_1b01_pub\house_1b01_pub_livespace0.p3d";
		class Doors
		{
			class Doors1
			{
...
class CfgBuildingInfo {
    class Land_House_1B01_Pub
    {
		class Livespace0
		{
			...
			classname = "Land_House_1B01_Pub_Livespace0"; // Classname of livespace object
			offset[] = { 2.3418, -2.19742, 2.33008 }; // Livespace object offset on spawn 2.3418, -2.19742, 2.33008
			homebook = "homebook";
			class Door0
			{
